...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from pre_models.common import AutoShape, DetectMultiBackend
    from pre_models.experimental import attempt_load
    from pre_models.yolo import ClassificationModel, DetectionModel, SegmentationModel
    ...
    try:
        ...
        if pretrained and channels == 3 and classes == 80:
            ...
            cfg = list((Path(__file__).parent / 'pre_models').rglob(f'{path.stem}.yaml'))[0]  # model.yaml path
