...
def parse_model(d, ch):  # model_dict, input_channels(3)            #############################################################################################################################
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            Bottleneck, SPP, SPPF, DWConv, BottleneckCSP, nn.ConvTranspose2d, DWConvTranspose2d, SPPCSPC, ADown, DWdown, RSPEN,
            RepNCSPELAN4, SPPELAN,RepNCSPELAN4_SENetV2,RepNCSPELAN4_FasterBlock, SPDConv, RepNCSPELAN4_SENetV1, DySnakeConv,RepNCSPELAN4_MSBlock,SPD_ADown}:       ############################################################################################
            c1, c2 = ch[f], args[0]
