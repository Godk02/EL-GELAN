...
class WandbLogger():
    """Log training runs, datasets, pre_models, and predictions to Weights & Biases.
    ...
    pre_models and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO pre_models:
